 ...
 * a certain distance.
 */
public class SmartMotorEx extends DriveMotorEx {
     ...
     * @param wheelRadius
     */
    public SmartMotorEx(DcMotorEx motor, WheelPosition motorPosition, int reduction, double wheelRadius) {
     ...
     * @param reduction
     */
    public SmartMotorEx(DcMotorEx motor, WheelPosition motorPosition, int reduction) {
