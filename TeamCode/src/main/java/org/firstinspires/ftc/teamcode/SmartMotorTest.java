...
public class SmartMotorTest extends AdvancedOpMode {
    ...
    @Override
    public void init() {
        frontLeftDrive = new SmartMotor(hardwareMap.get(DcMotor.class, "FrontLeftDrive"), WheelPosition.FRONT_LEFT, 16, 5);
        frontRightDrive = new SmartMotor(hardwareMap.get(DcMotor.class, "FrontRightDrive"), WheelPosition.FRONT_RIGHT, 16, 5);
        backLeftDrive = new SmartMotor(hardwareMap.get(DcMotor.class, "BackLeftDrive"), WheelPosition.BACK_LEFT, 16, 5);
        backRightDrive = new SmartMotor(hardwareMap.get(DcMotor.class, "BackRightDrive"), WheelPosition.BACK_RIGHT, 16, 5);
